...
@ApiModel(value = "FacialHeightBalanceDto 생성정보")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class FacialHeightBalanceDto {
    @ApiModelProperty(value = "String 형태의 lowerFace 값 입력", example = "lowerFace", required = true)
    @NotBlank
